    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner_application', models.BooleanField(blank=True, default=False, null=True)),
                ('application_email_sent', models.BooleanField(blank=True, default=False, null=True)),
                ('is_partner', models.BooleanField(blank=True, default=False, null=True)),
                ('partner_email_sent', models.BooleanField(blank=True, default=False, null=True)),
        ...
        migrations.CreateModel(
            name='PartnerProfile',
            fields=[
                ('company_image', models.ImageField(default='default.png', upload_to='companies/')),
                ('company_name', models.CharField(max_length=50)),
                ('company_website', models.CharField(max_length=200, null=True)),
                ('company_short_bio', models.TextField(max_length=200)),
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('partner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='profiles.profile')),
            ],
        ),
    ]
